  ...
  <div class="overflow-hidden">
    <Transition>
      <div v-if="showOverlayRef">
        ...
        <div class="flex items-center justify-center mt-5" v-if="currentGameRef">
          <span class="bg-white p-2 rounded-md"> {{ currentGameRef }} </span>
        </div>
      </div>
    </Transition>
  </div>
...
const currentGameRef = ref('')

socket.on(
  'ev_update_counters',
  ({ counterLeft, counterRight, labelLeft, labelRight, showOverlay, currentGame }: any) => {
